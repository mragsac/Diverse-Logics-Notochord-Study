# This script takes in a FLASH-combined FASTQ file and collapses 
...
print(f"{time.strftime('%Y-%m-%d %H:%M:%S',time.localtime())} Reading in the input FLASH-combined FASTQ file (.fasta/.fa format)")
FILENAME = sys.argv[1]
